...
%>
				<div class="new"><div class="img"><p class="price"><span class="left"><%=rs.slice(i,i+1).[0].name%></span><span class="right">￥<%=rs.slice(i,i+1).[0].price%></span></p>	<img src="<%=rs.slice(i,i+1).[0].img%>"></div><!-- .img-->	</div><!-- .new-->
<%
Next
Set rs=Nothing
end if
