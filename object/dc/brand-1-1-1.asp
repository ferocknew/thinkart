...
<!--#include file="lib/header_html.asp" -->
	...
	<div id="header" class="container_12">
		...
		<div class="banner">
			...
			<div class="banner-right">
				<img src="files/images/banner-right-brand.jpg">
			</div><!-- .banner-right-->
		</div><!-- .banner-->
		...
		<div class="header-nav">
			<ul class="grid_12">
				...
				<li class="nav-now"><a href="brand.html">融贷通产品</a></li>
				<li><a href="case.html">成功案例</a></li>
				<li><a href="industry-3.html">行业介绍</a></li>
				<li><a href="knowledge-1-1.html">融资常识</a></li>
	...
	<div id="content" class="container_12">
		...
		<div class="about-main">
			<h1>抵押类</h1>
			<a class="button" href="brand-1-1-1.html"><strong>企业厂房抵押贷款</strong></a>
			<a class="button" href="brand-1-1-2.html"><strong>企业流动资金贷</strong></a>
			<a class="button" href="brand-1-1-3.html"><strong>企业商业楼宇抵押贷款</strong></a>
			<div class="text">
				...
				4．全体股东的身份证。<br>
				5．企业贷款卡卡号与密码（如有）。<br>
				6．企业近两年的年终财务报表和当期财务报表。<br>
				7．提供一些近一年的、有说服力的供销合同。<br>
				8．各种资质认证书、专利证书、专业执照等（如有）。</p>

			</div>
			<img src="files/images/brand-right-img.jpg">
		</div><!-- .main-->
