...
<div id="content">
	...
	<div id="main">
		...
		<div id="news">
			<div id="news1">
				<ul>
					<li>Developed a large size means the cutter
						<div class="news-body">Means the gear  milling cutter is widely used in large modulus spur and helical gears and  herringbone gear tooth processing.</div>
					</li>
					<li>Premio introduced  multi-function mills
						<div class="news-body">Premio introduced a  kind of end-edge (End Tooth) in the multi-cutter &quot;α-shaped cutting aspect  AHJ&quot;</div>
					</li>
					<li>New high-speed  cutting TiAlN coated cutters
						<div class="news-body">
						  <p>Surface  coating technology development and application of the tool cutting performance  improvement and technological progress has played a key role.</p>
						</div>
					</li>
				</ul>
      </div>
			...
			<div id="news2">
				<ul>
					<li>
						...
						<div class="news-body">JJTOOLS CNC CNC tool  distributor in China</div>
					</li>
					<li>
						...
						<div class="news-body">
						  <p>Widin  general agent in China</p>
						</div>
					</li>
					<li>
						...
						<div class="news-body">
						  <p>Premio Germany, China, the designated professional  processing tools for sale</p>
						</div>
					</li>
					<li>
						<div class="news-image"><img src="files/images/news2-3.jpg" /></div>
						...
						<div class="news-body">
						  <p>Magnetic  clamping system clamping systems, mechanical clamping system, high precision  clamping system</p>
						</div>
					</li>
				</ul>
			</div>
			...
			<div id="news3" onClick="document.location='products.asp';" style="cursor:pointer;"> <img src="files/images/news3.jpg">
				<ul>
					...
					<li>4SUC-cutting to achieve  excellence</li>
				</ul>
