      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="50" class="bottomBorder1px"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="30" align="center" cl>一级：[ 当前未选择 ]</td>
              <td align="center">二级：[ 当前未选择 ]</td>
              <td align="center">三级：[ 当前未选择 ]</td>
            </tr>
            <tr>
              <td align="center" cl><select name="select" size="1" multiple="multiple" class="optList" id="select">
                <option>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>
            ...
            <tr>
              <td height="50" align="center"><input name="textfield" type="text" class="setClassInput" id="textfield" />
                <input name="change_info" type="submit" class="setShortBut" id="change_info2" value="添" />
                <input name="change_info2" type="submit" class="setShortButRed" id="change_info3" value="删" /></td>
              <td align="center"><input name="textfield2" type="text" class="setClassInput" id="textfield2" />
                <input name="change_info3" type="submit" class="setShortBut" id="change_info4" value="添" />                <input name="change_info5" type="submit" class="setShortButRed" id="change_info" value="删" /></td>
              <td align="center"><input name="textfield3" type="text" class="setClassInput" id="textfield3" />
                <input name="change_info4" type="submit" class="setShortBut" id="change_info6" value="添" />                <input name="change_info6" type="submit" class="setShortButRed" id="change_info5" value="删" /></td>
            </tr>
          </table></td>
        </tr>
    </table></td>
