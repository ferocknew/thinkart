...
fxip=fxip+1
  ...
  <tr>
    ...
    <%=rs("sjmp5_ip_ip")%></td>
    <td width="54" height="25" align="right" bgcolor="#FFFFFF"><font color="#339933"><%=rs("sjmp5_ip_hits")%></font>次&nbsp;</td>
  </tr><%
rs.movenext 
loop
rs.close
%>
  <tr>
    <td height="28" colspan="3" align="center" bgcolor="#F8F8F9"><p>今天来访独立IP：<font color="#339933">
<%=fxip%>
</font>个</td>
  </tr>
</table>
