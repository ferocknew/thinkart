...
<form id="form1" name="form1" method="post" action="contentClass_mng.asp?ccid=<%=ccid%>&cctype=<%=cctype%>" enctype="multipart/form-data">
	...
	<div class="breadcrumbs text_gray12_b link_gray12_b"> <img src="images/ico_breadcrumbs.gif" align="absmiddle" /> 当前位置: <a href="#"> 内容管理</a> / <span class="link_deepGray12_b"><a href="#">公司新闻</a></span> </div>
