...
<table id="tableStyle" class="table_style text_deepGray12_b" width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr class="tr_even">
    <td><img id="ck_list_1" src="images/checkbox_default.gif" align="middle" onclick="swCheck('ck_list_1','ck_input_1');" /><input name="ck_input_1" type="text" id="ck_input_1" value="0" size="5" maxlength="1" />
  ...
  <tr class="tr_even">
    <td><img src="images/checkbox_default.gif" align="middle" /></td>
    <td><span id="tableStyle">感谢国家感谢党</span></td>
    <td><span id="tableStyle">2010-11-12</span></td>
    <td><span id="tableStyle">公司新闻</span></td>
...
<img src="images/btm_prevPage.gif" align="top" /> 第 3 页 共 10 页 <img src="images/btm_nextPage.gif" align="top" />&nbsp;&nbsp; 选择 
<input name="textfield" type="text" class="input_page" id="textfield" maxlength="2" />
页 <a href="#"><img src="images/btm_enter.gif" align="top" /></a></div>
</body>
</html>
