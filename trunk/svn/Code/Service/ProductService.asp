...
Class ProductService
	...
	Public Function GetAllProduct()
		strSelectSql="select *,(select ClassName from ContentClass where ContentClass.ID=Product.ClassID) as ClassName,(select ClassType from ContentClass where ContentClass.ID=Content.ClassID) as ClassType from Product Order by Id Desc"
	...
	Public Function GetProductByObjProduct(objProduct)
		strSelectSql="select *,(select ClassName from ContentClass where ContentClass.ID=Product.ClassID) as ClassName,(select ClassType from ContentClass where ContentClass.ID=Content.ClassID) as ClassType from Product where 1=1"
	...
	Public Function GetProductById(id)
		strSelectSql="select *,(select ClassName from ContentClass where ContentClass.ID=Product.ClassID) as ClassName,(select ClassType from ContentClass where ContentClass.ID=Content.ClassID) as ClassType from Product where Id="&InputReplace(id)
		Set rs=DB.ExecuteQuery(strSelectSql)
		Set ModProduct=CreateProduct(rs)
		rs.Close
		Set rs=nothing 
	...
	Private Function CreateProduct(rs)
		...
		If Not rs.Eof Then
			...
			ModProduct.ClassType=OutputReplace(rs("ClassType"))
		End If
