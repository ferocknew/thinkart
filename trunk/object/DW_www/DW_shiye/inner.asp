					...
					<td width="281" valign="top"><table align="left" border="0" cellpadding="0" cellspacing="0" width="281">
							<tr>
								<td><table width="88%" border="0" align="center" cellpadding="0" cellspacing="0">
										...
										<tr>
											<td height="100" valign="top" bgcolor="#F1F5F8" id="index_menu" style="border-bottom:#d7d8da solid 1px; border-left: #d7d8da solid 1px; border-right:#d7d8da solid 1px; text-align:left; padding-left:20px;">
											<%
