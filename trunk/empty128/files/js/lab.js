$(function($){
    ...
    $.get("files/images/lab/info.xml?data=" + Date(), function(xml_data){
        ...
        $("item", xml_data).each(function(i){
            lab_con += "<div id=\"labItem\"><div class=\"labImage\"><a class=\"itemPicBlock\" href=\"files/images/lab/" + $("item:eq(" + i + ")", xml_data).attr("bimg") + "\"><img src=\"files/images/lab/" + $("item:eq(" + i + ")", xml_data).attr("simg") + "\"  border=\"0\" /></a></div>"
