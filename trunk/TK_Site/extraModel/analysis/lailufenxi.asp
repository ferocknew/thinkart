...
dim conn2,exec,sql2
dim sjmp5_geturl,sjmp5_getlyurl
...
sjmp5_geturl =Request.QueryString("sjmp5_geturl") 'sjmp5_https3 '
sjmp5_getlyurl =Request.QueryString("sjmp5_getlyurl") 'Cstr(Request.ServerVariables("HTTP_REFERER"))' 
sjmp5_getlyurls =Request.QueryString("sjmp5_getlyurl") 'Cstr(Request.ServerVariables("HTTP_REFERER"))' 
