...
*可以增加单个项目的历史进度节点。</p></td>
	...
	%>
          <tr>
            ...
            <input name="create_pj" type="button" class="setOptButtom" id="create_pj5" value="详细" onclick="javascript:document.location='projectdetail.asp?dt_id=<%=rs("id")%>';" />
            </span></td>
          </tr>
	<%
	i = i + 1
