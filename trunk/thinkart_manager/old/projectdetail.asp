    ...
    <td height="30" valign="top"><br />
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td height="25" align="right" class="bottomBorder1px"><input name="create_pj5" type="button" class="setOptButtomLong" id="create_pj" value="添加子任务" onclick="javascript:document.location='addprojectdetail.asp?dt_id=<%=dt_id%>';" />
          <input name="create_pj2" type="button" class="setOptButtomLong" id="create_pj5" value="返回项目列表" onclick="javascript:document.location='listproject.asp';" /></td>
        </tr>
      </table>
    <br />
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td height="50" align="center" class="bottomBorder1px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr class="rightBorder1px">
              <td height="25" colspan="2" align="center" class="rightBorder1px bottomDotted1px"><%=pj_desc%> -<a href="editproject.asp?edit_id=<%=dt_id%>" title="<%=pj_memo%>">[备]</a></td>
