...
<div id="menu_a">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="25" id="manvBar_sub"> <a href="myprojectlist.asp">&nbsp;&nbsp;+我的项目任务</a> &nbsp;&nbsp;||<a href="mylisttask.asp">&nbsp;&nbsp;+我的非项目任务</a> &nbsp;&nbsp;||&nbsp;&nbsp;<a href="listproject.asp">+所有项目任务</a> &nbsp;&nbsp;||&nbsp;&nbsp; <a href="listtask.asp">+所有非项目任务</a> &nbsp;&nbsp;||&nbsp;&nbsp; <a href="listfinishtask.asp">+已完成任务</a></td>
      </tr>
    </table>
</div> 
<div id="menu_b">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="25" id="manvBar_sub">&nbsp;&nbsp;<a href="listcontract.asp">+合同管理</a> &nbsp;&nbsp;||&nbsp;&nbsp; <a href="#">+供应商管理</a> &nbsp;&nbsp;||&nbsp;&nbsp; <a href="#">+历史询价管理</a>&nbsp;&nbsp;||&nbsp;&nbsp; <a href="#">+网站备案管理</a></td>
      </tr>
    </table>
</div>
<div id="menu_c">    
...
<div id="menu_d">    
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="25" id="manvBar_sub">&nbsp;&nbsp;<%if session("power") = 3 then%><a href="listuser.asp">+用户管理</a> &nbsp;&nbsp;||<%end if%>&nbsp;&nbsp; <a href="listcalendar.asp">+工作日志</a></td>
      </tr>
    </table>
</div>