...
Class Cls_ShowoPage
	...
	' Conn 得到数据库连接对象
	'================================================================
	Public Property Let PageNum(ByVal CurrPage)
		Showo_CurrPage=CheckNum(Trim(CurrPage),1,-1) '获取当前面的值
	End Property
	...
	Public Property Get ResultSet()
		dim ResultSet_ :	redim ResultSet_(0)
		ResultSet=Null
		'记录总数
		...
		'页数
			...
			Select Case Showo_DbType
				Case "AC" 'ac数据库
					...
					Showo_Rs.Open ResultSet_Sql,Showo_Conn,1,1
