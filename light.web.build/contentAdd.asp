...
if c_content <> "" and ctitle <> "" then
response.write ctitle & "<br />" & c_content
end if
%>
...
<textarea id="c_content" name="c_content" rows="20" cols="80" style="width: 80%">
	</textarea>        
        </td>
      </tr>
      <tr>
