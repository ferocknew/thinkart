...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr onMouseOver="this.bgColor = '#cccccc';" onMouseOut="this.bgColor='#ffffff';">
    ...
    <td align="center" class="bottom_line"><a href="contentEdit.asp?editid=<%=rs("id")%>">编辑</a> | <a href="#" onClick="{if(confirm('确定删除吗?')){window.location='contentMng.asp?delid=<%=rs("id")%>';return true;}return false;}" style="cursor:pointer;">删除</a></td>
  </tr>
	<%
    i = i + 1
    rs.Movenext
