...
sqlr = "SELECT * FROM tm_task where id = "&edit_id&""
...
*备注项可留空</p></td>
    ...
    <td height="30" valign="top"><br />
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="50%" align="left" class="bottomBorder1px"><table width="120" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="120" height="35" class="tabCard">+ 编辑非项目任务</td>
            </tr>
          </table></td>
      ...
      <br />
      <form action="process_edit_task.asp?edit_id=<%=edit_id%>" method="post" name="form1">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
