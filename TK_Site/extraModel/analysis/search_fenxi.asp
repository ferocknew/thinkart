...
ii=ii+1
  %>
      <tr>
        ...
        <td width="60" height="25" align="right" bgcolor="#FFFFFF"><font color="#339933"><%=rs("sjmp5_url_hits")%></font>次&nbsp;</td>
      </tr>
      <%
rs.movenext 
loop
...
%>
      <tr>
        <td height="28" colspan="3" align="center" bgcolor="#F8F8F9"><p><a href="search_html_ly.asp?search=<%=search%>"><%=search%>记录访问：<font color="#339933">
            <%
...
i=i+1
  %>
      <tr>
        ...
        <td width="61" height="25" align="right" bgcolor="#FFFFFF"><font color="#339933"><%=rs("sjmp5_ip_hits")%></font>次&nbsp;</td>
      </tr>
      <%
rs.movenext 
loop
...
%>
      <tr>
        <td height="28" colspan="4" align="center" bgcolor="#F8F8F9"><p><a href="search_ip.asp?search=<%=search%>"><%=search%>来访独立IP ：<font color="#339933"> <%
...
iimember=iimember+1
  %>
      <tr>
        ...
        <td width="60" align="right" bgcolor="#FFFFFF"><font color="#339933"><%=rs("sjmp5_html_hits")%></font>次&nbsp;</td>
      </tr>
      <%
rs.movenext 
loop
...
%>
      <tr>
        <td height="28" colspan="3" align="center" bgcolor="#F8F8F9"><p><a href="search_html.asp?search=<%=search%>"><%=search%> 有 <font color="#339933">
            <%
...
iikey=iikey+1
  %>
      <tr>
        ...
        <td width="60" align="right" bgcolor="#FFFFFF"><font color="#339933"><%=rs("sjmp5_keyword_hits")%></font>次&nbsp;</td>
      </tr>
      <%
rs.movenext 
loop
...
%>
      <tr>
        <td height="28" colspan="3" align="center" bgcolor="#F8F8F9"><p><a href="search_keyword.asp?search=<%=search%>"><%=search%> 有 <font color="#339933">
            <%
...
%>
  ...
  <tr align="left">
    <td height="17" colspan="2" valign="top"><!-- #include file="sjmp5_foot.asp" --></td>
  </tr>
</table>
<br />
</body>
