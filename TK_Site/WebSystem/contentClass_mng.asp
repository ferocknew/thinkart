...
<div class="content_ctrlbar text_deepGray12_b">
  ...
  <table border="0" align="right" cellpadding="0" cellspacing="0" class="link_deepGray12_b">
    <tr>
    <td><a href="#" onclick="hide_alltrees()"><img src="images/ico_showList.gif" align="middle" /> 全部折叠</a></td>
    <td><a href="#" onclick="show_alltrees()"><img src="images/ico_hideList.gif" align="middle" /> 全部展开</a></td>
  </tr>
</table>
</div>
	...
	<%If contentclassDic.Items()(i).ID <> ccid Then%>
       <div class="programsItem" id="div_trees_<%=contentclassDic.Items()(i).HisId%><%=contentclassDic.Items()(i).ID%>" name="div_trees_lv<%=contentclassDic.Items()(i).LV%>">
          <div class="programsList tree<%=contentclassDic.Items()(i).LV%>_<%=contentclassDic.Items()(i).Style%>" name="div_trees_lv<%=contentclassDic.Items()(i).LV%>_class" onclick="tree_click(this,'div_trees_<%=contentclassDic.Items()(i).HisId%><%=contentclassDic.Items()(i).ID%>');"></div>
            <div class="programsList_text" onclick="window.location='contentClass_mng.asp?ccid=<%=contentclassDic.Items()(i).ID%>'"><%=contentclassDic.Items()(i).ClassName%></div></div>
    <%Else%>
        <div class="programsItem" id="div_trees_<%=contentclassDic.Items()(i).HisId%><%=contentclassDic.Items()(i).ID%>" name="div_trees_lv<%=contentclassDic.Items()(i).LV%>">
                ...
                <div class="editBar text_white12_b">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="200">添加子分类 <input name="ClassNameSon" type="text" class="programsEdit_input" id="ClassNameSon" size="8" />
                            <input class="programsEdit_btm" type="button" name="button2" id="button2" onclick="contentClass_add_son_check()" value=" " />
                            </td>
                            <td class="editBar_td" width="161">升降序 <img src="images/btm_putDown.gif" align="middle" style="cursor:pointer" onclick="orderdown()" /><img src="images/btm_putUp.gif" align="middle" style="cursor:pointer" onclick="orderup()" />
                            ...
                            <td class="link_white12_b editBar_td" width="117"><a href="#" onclick="contentClass_del_check()">删除此分类 <img src="images/ico_trash.gif" align="absmiddle" /></a></td>
                        </tr>
                    </table>
                </div>
