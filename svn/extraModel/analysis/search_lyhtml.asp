	...
	function date_init(obj,name)
{
  ...
  <tr>
    <td height="30" colspan="3" align="center" background="images/tab_bg.gif" bgcolor="#eeeeee"><b>外部链接来源排行榜</b>( <%=search%>有<font color="#339933">
<%
rs.close
...
iimember=iimember+1
  ...
  <tr>
    ...
    <td width="250" align="left" bgcolor="#FFFFFF"><img src="images/smallbg.jpg" width=<%=fix(rs("sjmp5_lyhtml_hits")/key_tj*150)%> height=10>&nbsp;<%=fix(rs("sjmp5_lyhtml_hits")/key_tj*100)%>%&nbsp;&nbsp;(<font color="#339933"><%=rs("sjmp5_lyhtml_hits")%></font>次)&nbsp;</td>
  </tr><%
   j=j+1
  rs.movenext
  loop
